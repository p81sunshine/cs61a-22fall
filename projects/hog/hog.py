...
def perfect_square(score):
    """Judge whether the score is perfect number"""
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    # In all posiball cases, judge whether roll the same dice
    flag = 0
    roll = strategy(0, 0)
    for i in range(0, goal):
        for j in range(0, goal):
            k = strategy(i, j) # Simulate all cases
            if roll != k:
                flag = 1
                break
